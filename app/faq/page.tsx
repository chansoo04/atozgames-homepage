    ...
    <div className="bg-white text-gray-900 min-h-screen px-5 md:px-20 py-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
        <ul className="flex space-x-5 border-b md:border-none pb-2 md:pb-0">
          ...
          <li className="hover:text-blue-500 cursor-pointer">게임문의</li>
          <li className="hover:text-blue-500 cursor-pointer">유료/결제</li>
          <li className="hover:text-blue-500 cursor-pointer">계정</li>
        </ul>
