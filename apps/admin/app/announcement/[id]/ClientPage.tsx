...
export default function ClientPage({ announcement }: { announcement: any }) {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <div
                className={`flex items-center rounded-full font-semibold ${announcement.category === "공지" ? "bg-serve text-gray-100" : "bg-primary text-gray-700"}`}
                style={{
